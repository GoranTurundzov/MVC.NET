...
namespace SEDC.PizzaApp.DataAccess.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "FirstName", "LastName", "Phone", "UserId" },
                values: new object[,]
                {
                    { 1, "Bob Street", "Bob", "Bobsky", 1231123123123L, 0 },
                    { 2, "Jill Street", "Jill", "Wayne", 80044455123L, 0 }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "Delivered", "PaymentMethod", "PizzaStore", "UserId" },
                values: new object[] { 1, true, 2, "Pizza store Skopje", 1 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "Delivered", "PaymentMethod", "PizzaStore", "UserId" },
                values: new object[] { 2, false, 2, "Pizza store Skopje", 1 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "Delivered", "PaymentMethod", "PizzaStore", "UserId" },
                values: new object[] { 3, true, 1, "Pizza store Skopje", 2 });
